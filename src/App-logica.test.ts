 ...
 * vaciado (17:3).
 */
describe('RUTAS_DE_SUBPAGINA deriva exactamente los destinos no-ancla de ENLACES_NAVEGACION', () => {
  it('es exactamente ["/campanas", "/blog", "/tienda"], sin anclas y sin nada de más', () => {
    // Literal escrito a mano: nunca se compara contra ENLACES_NAVEGACION
    // importado (patrón doble-de-test-anclado-al-literal-no-al-simbolo).
    expect(RUTAS_DE_SUBPAGINA).toEqual(['/campanas', '/blog', '/tienda'])
  })
})
