 ...
 * para distinguir un destino de ruta de un destino de ancla interna.
 *
 ...
 */
export const RUTAS_DE_SUBPAGINA = ENLACES_NAVEGACION.filter((enlace) => !esAncla(enlace.destino)).map(
  (enlace) => enlace.destino,
)
